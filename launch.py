...
#
# Glyn Morgan 
# Version: Final-2 02/12/17
#
# Needs the GPIO Zero Library
#
# The PI Hut Xms tree board is optionaly modified with a
...
def spiral():
    # funtion to create a spiral pattern that repeats for a while
...
def random_led():
    # funtion that turns off and on random leds
...
def top_down(forward):
    # funtion that lights the leds from top down.
